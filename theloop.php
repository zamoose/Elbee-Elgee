	 <?php /* Start The Loop */ if (have_posts()) { while (have_posts()) { the_post(); ?>
		...
		<div id="post-<?php the_ID(); ?>" class="wppost">
			...
			<span class="postmeta">Posted by <?php the_author(); ?> on <?php the_time('F wS, Y'); ?> | <?php comments_popup_link('No Comments', '1 Comment', '% Comments'); ?><?php edit_post_link(' | Edit this entry.', '', ''); ?></span>
			<div class="itemtext">
				<?php 
